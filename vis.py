...
ENG_TO_ATTRS = {"exchangeAcronym": "Exchange", "issFtse1Industry": "Industry",
                 "issFtse3Sector": "Sector",  "assetType": "Asset Type"}


def vis_pie(p, attr):
    """
    Create the visualization in pie chart form.
...
def attr_to_english(attr):
    return ENG_TO_ATTRS.get(attr, attr.capitalize())
